...
namespace ELibraryManagement
{
    public partial class usersignup : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (checkMemberExist())
            {
                Response.Write("<script>alert('Member with same ID already exist, Please try another ID');</script>");
            }
        ...
        bool checkAllFields()
        {
            if(TextBox1.Text.Trim()==""|| TextBox2.Text.Trim() == ""|| TextBox3.Text.Trim() == ""|| TextBox4.Text.Trim() == ""|| TextBox5.Text.Trim() == ""|| TextBox6.Text.Trim() == ""|| TextBox8.Text.Trim() == ""|| TextBox7.Text.Trim() == ""|| TextBox9.Text.Trim() == "")
            {
